...
<div class="bg-white p-5 rounded-md divide-y">
    <div class="my-4 flex justify-between items-center">
        <h1 class="text-xl font-medium">Edit Data Pustakawan</h1>
        <a href="/pustakawans">
    ...
    <form action="/pustakawan/update/<?php echo $pustakawan->id; ?>" method="POST" class="mx-auto py-5">
        <input type="hidden" name="_method" value="UPDATE">
        <div class="mb-6">
            <label for="name" class="block mb-2 text-sm text-gray-600">Nama</label>
